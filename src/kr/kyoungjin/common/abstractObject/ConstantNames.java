...
public class ConstantNames {
	...
	public static final String EXCEL_KEY = "excelKey";
	
	public static final String EXCEL_STATUS_DS_REG = "DS_REG";
	public static final String EXCEL_STATUS_DS_DS_POS_START = "DS_POS_START";
